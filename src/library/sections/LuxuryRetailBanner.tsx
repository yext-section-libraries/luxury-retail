...
const LuxuryRetailBannerComponent: PuckComponent<LuxuryRetailBannerProps> = ({
  data,
  styles,
  section,
  puck,
...
export const LuxuryRetailBanner: YextComponentConfig<LuxuryRetailBannerProps> = {
  ...
  render: (props) => (
    ...
    >
      <LuxuryRetailBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};

export const config: SectionConfig = {
  id: "LuxuryRetailBanner",
  displayName: "Banner",
  description: "Banner",
  pageSetTypes: ["ENTITY"],
};
